...
The openai provider reads OPENAI_API_KEY from the process environment. The codex, claude,
and cursor providers use the existing subscription-authenticated session of that CLI.
None of them read .env files.
